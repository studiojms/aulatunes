...
jest.mock('./service/AlbumService');

describe('<App />', () => {
  describe('API Requests', () => {
    it('should list the albums received from the API', async () => {
      AlbumService.listTopAlbums.mockResolvedValue({
        feed: {
          entry: [
            {
              'im:name': {
      ...
      expect(await screen.findByText('Heart - Eric Church')).toBeInTheDocument();
